...
export type ProductStatus = '' | 'normal' | 'disabled' | 'draft'
...
export const createMockProducts = (): ProductRecord[] => [
  {
    basicInfo: {
      ...
      russianName: 'Портативный блендер',
      shortName: '无线榨汁杯',
  ...
  },
  {
    basicInfo: {
      ...
      russianName: 'Бесшумная Bluetooth-клавиатура',
      shortName: '蓝牙键盘',
  ...
  },
  {
    basicInfo: {
      ...
      russianName: 'Складной органайзер для ящика',
      shortName: '抽屉收纳盒',
